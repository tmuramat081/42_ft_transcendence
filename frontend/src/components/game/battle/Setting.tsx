        ...
        {playState === PlayState.stateSelecting && (
          <>
            <Grid item>
              ...
              <FormControl>
                <FormLabel id="difficulty-radio-buttons-group-label">難易度</FormLabel>
                <RadioGroup
                  row
                ...
                <FormLabel id="matchpoint-radio-buttons-group-label">マッチポイント</FormLabel>
                <RadioGroup
                  row
